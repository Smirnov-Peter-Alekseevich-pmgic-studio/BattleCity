...
{
    {
        ...
        auto pDefaultShaderProgram = resourceManager.LoadShaders("DefShaders", "res/shaders/vertex.shdr", "res/shaders/fragment.shdr");
        ...
        resourceManager.LoadTexture("def","res/textures/map_16x16.png");
